//Exercici 17 - Ordena 4 números (+++)

/*Escreva um algoritmo que leia 4 números reais (double) em qualquer ordem e os apresente de forma
ordenada na tela.
Entrada: O programa deve ler 4 valores reais*/
